...
// =================================================================================================
// =================================================================================================
// commit: 7b9885133108ae301ddd16e2651320f54cafeba7
...
template <typename T, unsigned long N> struct filldata<T[N]> {
...
template <unsigned long N> struct filldata<const char[N]> {
...
template <typename T, typename detail::enable_if<!detail::is_enum<T>::value,
                                                 bool>::type = true>
...
#define DOCTEST_DO_BINARY_EXPRESSION_COMPARISON(op, op_str, op_macro)          \
  ...
  template <typename R, typename enable_if<                                    \
...
struct DOCTEST_INTERFACE ExpressionDecomposer {
  ...
  template <typename L> Expression_lhs<const L> operator<<(const L &&operand) {
    return Expression_lhs<const L>(doctest::detail::forward<const L>(operand),
                                   m_at);
  }

  template <typename L,
            typename enable_if<!doctest::detail::is_rvalue_reference<L>::value,
                               void>::type * = nullptr>
...
DOCTEST_INTERFACE bool decomp_assert(assertType::Enum at, const char *file,
                                     int line, const char *expr, Result result);
...
template <bool C> struct StringStreamBase {
  template <typename T> static void convert(std::ostream *s, const T &in) {
    *s << toString(in);
  }
    ...
    if (!doctest::getContextOptions()->no_throw) {                             \
      ...
      try {                                                                    \
        DOCTEST_CAST_TO_VOID(expr)                                             \
          ...
          const typename doctest::detail::remove_const<                        \
...
template <typename T> using AtomicOrMultiLaneAtomic = std::atomic<T>;
...
template <typename T> using AtomicOrMultiLaneAtomic = MultiLaneAtomic<T>;
